                        ...
                        <tbody class="border-0">
                            ...
                            <tr>
                                ...
                                <td class="p-3 align-middle border-light">
                                    <p class="mb-0 small">${{ $prod->price }}</p>
                                </td>
                                <td class="p-3 align-middle border-light">
                                ...
                                <td class="p-3 align-middle border-light">
                                    <p class="mb-0 small">${{ $prod->total }}</p>
                                </td>
                                <td class="p-3 align-middle border-light">
                                    <a class="reset-anchor" href="{{ url('/delete-from-cart/'.$prod->id) }}">
                ...
                <div class="bg-light px-4 py-3">
                    <div class="row align-items-center text-center">
                        <div class="col-md-6 mb-3 mb-md-0 text-md-start">
                            <a class="btn btn-link p-0 text-dark btn-sm" href="{{ url('/') }}">
                        ...
                        <div class="col-md-6 text-md-end">
                            <form action="{{ url('/submit-cart') }}" method="POST">
                                ...
                                <button class="btn btn-outline-dark btn-sm" href="checkout.html">
