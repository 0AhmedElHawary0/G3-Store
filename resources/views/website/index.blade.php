...
<div class="container">
    ...
    <section class="pt-5">
        ...
        <div class="row">
            @foreach ($categories->chunk(3)[0] as $category)

            <div class="col-md-4">
                <a class="category-item" href="{{ url('/category/'. $category->id) }}" style="height: 100%;">
                    <img class="img-fluid" src="{{ asset($category->photo) }}" style="height: 100%;" />
                ...
                <div class="product text-center">
                    <div class="position-relative mb-3">
                        ...
                        <a class="d-block" href="{{ url('/product/' . $product->id) }}">
                            <img class="img-fluid w-100" src="{{ asset($product->photo) }}">
                        </a>
                    ...
                    <h6>
                        <a class="reset-anchor" href="{{ url('/product/' . $product->id) }}">{{ $product->name }}</a>
                    </h6>
